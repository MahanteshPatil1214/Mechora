...
def _to_out(fam) -> FamilyOut:
    return FamilyOut(
        ...
        family_type=getattr(fam, "family_type", "precursor") or "precursor",
        core_mechanism=getattr(fam, "core_mechanism", {}) or {},
        context=getattr(fam, "context", {}) or {},
        recurrence=getattr(fam, "recurrence", {}) or {},
        why_it_matters=getattr(fam, "why_it_matters", "") or "",
